...
if __name__ == "__main__":
    taskname = 'GAT_distributed_benchmark'
    ...
    parser.add_argument('-l', '--layers', type=int, nargs="?", default=2, help='The number of layers in the GAT model.')
    ...
    utils.mpi_print(cart_rank, f'Testing {num_layers}-layer GAT distributed {task} on {Px}x{Py} processes...')
...
"""
    ...
    # Logging the results
    modelname = 'GAT'
    filename = 'GAT_distr_results.csv'
